          ...
          <div className="card p-6 text-center">
            <div className="relative inline-block">
              <img
                ...
                onError={(e) => {
                  e.target.src = `${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/public/default-avatar.svg`;
                }}
              />
            ...
            {currentUser?.isVetVerified && (
              <div className="mt-2">
                <span className="badge badge-success">Verified Veterinarian</span>
              </div>
            )}
            <div className="mt-4">
              {currentUser?.bio ? (
                <p className="text-sm text-gray-700 italic">"{currentUser.bio}"</p>
              ) : (
                <p className="text-sm text-gray-500 italic">Add a bio to tell others about yourself</p>
              )}
            </div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {!currentUser?.isEmailVerified && (
                        <span className="badge badge-warning mt-1">Unverified</span>
                      )}
                    </div>
          ...
          <div className="space-y-4">
            {currentUser?.role === 'vet' && !currentUser?.isVetVerified && (
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <h4 className="font-medium text-yellow-800">Veterinarian Verification</h4>
                <p className="text-sm text-yellow-700 mt-1">
                  Complete your veterinarian verification to start accepting appointments.
                </p>
